...
import "./SafeMath.sol";
import "./LabradoLibrary.sol";

// library containing some math for dealing with the liquidity shares of a pair, e.g. computing their exact value
// in terms of the underlying tokens
library LabradoLiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        (reserveA, reserveB) = LabradoLibrary.getReserves(
            factory,
            tokenA,
            tokenB
        );
    ...
    function getLiquidityValue(
        ...
        (uint256 reservesA, uint256 reservesB) = LabradoLibrary.getReserves(
            factory,
            tokenA,
            tokenB
        );
        ...
        bool feeOn = ILabradoFactory(factory).feeTo() != address(0);
